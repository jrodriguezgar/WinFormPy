"""
DataGrid CRUD Demo - Complete Product Management System

This example demonstrates:
- DataGrid with full CRUD operations (Create, Read, Update, Delete)
- Pagination and sorting
- Search and filtering
- Integration with RecordFormPanel for detail editing
...
sys.path.insert(0, os.path.join(_project_root, 'winformpy', 'ui_elements', 'record_form'))

from winformpy.winformpy import (
    Form, Panel, Button, Font, FontStyle, DockStyle, FlatStyle, Application
)
from winformpy.ui_elements.data_grid.data_grid_panel import DataGridPanel
from winformpy.ui_elements.data_grid.data_grid_manager import DataGridManager
from winformpy.ui_elements.record_form.record_form_panel import RecordFormPanel
from winformpy.ui_elements.record_form.record_form_backend import InMemoryRecordBackend
...
class ProductBackend(DataGridBackend):
    ...
    def fetch_data(self, request: DataRequest) -> DataResponse:
        ...
        if request.search_text:
            ...
            filtered = [
                r for r in filtered
                if matches(r.get("product", "")) or matches(r.get("category", ""))
            ]
