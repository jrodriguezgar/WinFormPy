...
# Backward compatibility: keep the functions as wrappers
def get_system_colors() -> Dict[str, str]:
    """Deprecated: Use ColorManager.get_system_colors() instead."""
    return ColorManager.get_system_colors()


def get_system_color(color_type: str = 'control') -> str:
    """Deprecated: Use ColorManager.get_system_color() instead."""
    return ColorManager.get_system_color(color_type)
