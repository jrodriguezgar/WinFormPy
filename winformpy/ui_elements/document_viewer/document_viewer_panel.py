...
from winformpy.winformpy import (
    Panel, Label, Button, PictureBox, TextBox, DockStyle, Font, FontStyle, PrinterSettings
)
...
class DocumentViewerPanel(Panel):
    ...
    def _show_printer_setup(self):
        ...
        from winformpy.winformpy import Native
...
if __name__ == '__main__':
    from winformpy.winformpy import Form, Application, MessageBox, OpenFileDialog, Button
