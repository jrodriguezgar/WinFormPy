...
from winformpy.winformpy import (
    Form, Label, Button, TextBox, MenuStrip, ToolStripMenuItem,
    StatusStrip, ToolStripStatusLabel, DockStyle, FormBorderStyle, MessageBox, Application
)
...
try:
    ...
    from email_manager import EmailManager, EmailEventType
    from email_panel import EmailPanel
    from email_backend import EmailAccount
...
class EmailForm(Form):
    ...
    def _setup_menu(self):
        ...
        ToolStripMenuItem(edit_menu, {'Text': 'Undo'})
        ToolStripMenuItem(edit_menu, {'Text': 'Redo'})
        ToolStripMenuItem(edit_menu, {'Text': '-'})
        ToolStripMenuItem(edit_menu, {'Text': 'Cut'})
        ToolStripMenuItem(edit_menu, {'Text': 'Copy'})
        ToolStripMenuItem(edit_menu, {'Text': 'Paste'})
        ToolStripMenuItem(edit_menu, {'Text': '-'})
        ToolStripMenuItem(edit_menu, {'Text': 'Select All'})
        ToolStripMenuItem(edit_menu, {'Text': '-'})
        ToolStripMenuItem(edit_menu, {'Text': 'Find...'})

        # View menu
        view_menu = ToolStripMenuItem(self._menu, {'Text': 'View'})

        ToolStripMenuItem(view_menu, {'Text': 'Folder Pane'})
        ToolStripMenuItem(view_menu, {'Text': 'Reading Pane'})
        ToolStripMenuItem(view_menu, {'Text': '-'})
        sort_by = ToolStripMenuItem(view_menu, {'Text': 'Sort By'})

        ToolStripMenuItem(sort_by, {'Text': 'Date'})
        ToolStripMenuItem(sort_by, {'Text': 'From'})
        ToolStripMenuItem(sort_by, {'Text': 'Subject'})
        ...
        ToolStripMenuItem(message_menu, {'Text': 'Mark as Read'})
        ToolStripMenuItem(message_menu, {'Text': 'Mark as Unread'})
        ToolStripMenuItem(message_menu, {'Text': 'Toggle Star'})

        ToolStripMenuItem(message_menu, {'Text': '-'})

        ToolStripMenuItem(message_menu, {'Text': 'Move To'})
        ...
        ToolStripMenuItem(tools_menu, {'Text': 'Message Filters...'})
        ToolStripMenuItem(tools_menu, {'Text': '-'})
        ToolStripMenuItem(tools_menu, {'Text': 'Options...'})

        # Help menu
        help_menu = ToolStripMenuItem(self._menu, {'Text': 'Help'})

        ToolStripMenuItem(help_menu, {'Text': 'Help Contents'})
