...
from winformpy.winformpy import (
    ...
    TabControl, TabPage,
    DockStyle, FlatStyle, Font, FontStyle,
    MessageBox, DialogResult, OpenFileDialog,
    Application, InputBox, Native,
    _ensure_tkinterweb
)
...
class WebBrowserUI(Form):
    ...
    def _create_tab_buttons(self):
        ...
        self._tab_buttons_frame = Native.Frame(notebook, bg='#E8E8E8')

        # New tab button '+'
        self._btn_new_tab = Native.Button(
        ...
        self._btn_close_tab = Native.Button(
            self._tab_buttons_frame,
            text='✕',
            font=('Segoe UI', 9),
            width=2,
        ...
        # Tab info label
        self._tab_info_label = Native.Label(
            self._tab_buttons_frame,
            text='Tab 1 of 1',
            font=('Segoe UI', 8),
            bg='#E8E8E8'
    ...
    def _setup_tab_context_menu(self):
        ...
        if hasattr(self._tab_control, '_tk_widget') and self._tab_control._tk_widget:
            ...
            # Create context menu
            self._tab_menu = Native.Menu(notebook, tearoff=0)
