...
from winformpy.winformpy import (
    ...
    DockStyle, FlatStyle,
    MessageBox, OpenFileDialog, SaveFileDialog, Clipboard, Application
)
...
class WordProcessorForm(Form):
    ...
    def _create_view_menu(self):
        ...
        for level in self.ZOOM_LEVELS:
            ...
            item.Click = lambda s, e, lvl=level: self._set_zoom(lvl)
